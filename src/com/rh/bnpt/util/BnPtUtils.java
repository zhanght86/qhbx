...
public class BnPtUtils {
    ...
    private static BnPtUtils chineseSpelling = new BnPtUtils();  
    public static BnPtUtils getInstance() {  
    ...
    public static String trans2PinYin(String str) {  
        return BnPtUtils.getInstance().convertAll(str);  
    }  
