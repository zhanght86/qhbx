...
public class RhFileClient {
    ...
    static {
        String fileTypes = "doc;docx;pdf;wps;xls;xlsx;txt;htm;html;xml;csv;et;";
     ...
     * 
     * @param fileType 文件类型
     * @return 是否是可以抽取内容的文件类型
     */
    public static boolean aviableFileType(String fileType) {
    ...
    public String extract(InputStream src) throws IOException {
        ...
        log.warn("##RhFileClient.extract spend time:" + sw.getTime());
        return text;
    }
