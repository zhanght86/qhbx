...
/**
 * @author ayf
 * @version v1.0 创建时间：2013-8-12 上午7:23:18 类说明 用户登录 ldap验证类
 */
public class LdapLoginModule extends AbstractLoginModule {
	...
	public UserBean authenticate(Bean paramBean) {
		...
		if (datas != null && datas.size() > 0) {
			...
			env.put(Context.SECURITY_PRINCIPAL, loginName + "@qianhaire.local"); // 用户的dn
...
//    			ServDao.save(ServMgr.SY_ORG_USER, userBean);
			...
			throw new RuntimeException("门户系统中无此用户，请与系统管理员联系！");
		}
	}
}
