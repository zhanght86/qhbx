...
public class AdminOutBean extends WfOut {
    ...
    public void fillOutBean(WfAct wfAct) {
        ...
        //批量打印20150205
//        if (canDisplayBtn(adminBtns, WfBtnConstant.BUTTON_WFPRINTDAGDINFO)) {
//        	addPRINTSBtn();
//        }
     ...
     * 添加批量打印按钮20150205
     */
    private void addPRINTSBtn() {
        Bean gwManagerBtn = this.getProcServDefAct(WfBtnConstant.BUTTON_WFPRINTDAGDINFO);
        this.addBtnBean(gwManagerBtn);
    }
