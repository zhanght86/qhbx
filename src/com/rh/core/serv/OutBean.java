...
public class OutBean extends Bean {
     ...
     * @return 本对象
     */
    public OutBean setCount(int count) {
     ...
     * @deprecated
     */
    public OutBean setPage(Bean page) {
        this.set(PAGE, page);
        return this;
    }
    ...
    public OutBean setPage(int showNum) {
        Bean page = new Bean().set(Constant.NOWPAGE, 1).set(Constant.PAGES, 1)
                .set(Constant.SHOWNUM, showNum).set(Constant.ALLNUM, showNum);
        this.set(PAGE, page);
        return this;
    }
