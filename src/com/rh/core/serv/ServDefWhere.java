...
public class ServDefWhere extends CommonServ {
    ...
    public Bean impWheres(Bean paramBean) {
        ...
        String[] script = {"\"@ROLE_CODES@\".indexOf(\"'RGSLD'\") >= 0", 
                ...
                "1 == 1"};
        String[] content;
        int[] flowFlag = {Constant.FLOW_FLAG_NONE, Constant.FLOW_FLAG_NONE, Constant.FLOW_FLAG_NONE, 
                Constant.FLOW_FLAG_NONE};
        if (servDef.hasWfAuto()) { //如果在流程中，则启用流经判断
            content = new String[] {"", "", "", ""};
            flowFlag[1] = Constant.FLOW_FLAG_TDEPT;
            flowFlag[2] = Constant.FLOW_FLAG_DEPT;
            flowFlag[3] = Constant.FLOW_FLAG_USER;
