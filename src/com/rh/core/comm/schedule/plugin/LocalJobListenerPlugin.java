...
//        log.debug("jobToBeExecuted, update job state...");
        ScheduleMgr.getInstance().setLocalJobStatus(context.getJobDetail().getKey(), "RUNNING");
    }
    ...
    public void jobWasExecuted(JobExecutionContext context, JobExecutionException jobException) {
        ...
        // update job state
        ScheduleMgr.getInstance().setLocalJobStatus(context.getJobDetail().getKey(), "ALIVE");
//        log.debug("jobWasExecuted, update job state...");
    ...
    private void saveHistory(JobExecutionContext context, boolean successed, String desc) {
        ...
        try {
            paramBean.set("SCHED_NAME", ScheduleMgr.getInstance().getLocalSchedulerName());
