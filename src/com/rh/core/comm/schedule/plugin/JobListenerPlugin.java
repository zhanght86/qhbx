...
package com.rh.core.comm.schedule.plugin;
...
import com.rh.core.comm.schedule.serv.SchedBaseServ;
...
public class JobListenerPlugin implements SchedulerPlugin, JobListener {
    ...
    /** schedule service */
    private SchedBaseServ schedServ = new SchedBaseServ();
    ...
    public void jobToBeExecuted(JobExecutionContext context) {
        ...
        schedServ.updateState(context.getJobDetail().getKey(), "RUNNING");
    }
    ...
    public void jobWasExecuted(JobExecutionContext context, JobExecutionException jobException) {
        Object jobDesc = context.get(ScheduleMgr.CONTEXT_JOB_EXECUTED_DESC_KEY);
        ...
        try {
            ...
            schedServ.updateState(context.getJobDetail().getKey());
    ...
    private void saveHistory(JobExecutionContext context, boolean successed, String desc) {
        ...
        try {
            paramBean.set("SCHED_NAME", ScheduleMgr.getInstance().getSchedulerName());
        } catch (SchedulerException e) {
            e.printStackTrace();
        }
        ...
        // is recovery job
        if (ScheduleMgr.getInstance().isRecoveryTrigger(trigger.getKey())) {
