 ...
 * @author chaizhiqiang 
 */
public class NewsAttachDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params,
        ...
        Bean paramBean = new Bean()
            ...
            .set("attachCount", attachCount).set("pollCount", pollCount);
        
        Bean news = NewsMgr.getInstance().getNewsAttach(paramBean);
