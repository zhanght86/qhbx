 ...
 * 文辑阅读排行
 */
public class DoclistReadTopDirective implements TemplateDirectiveModel {
    /** log */
    private static Log log = LogFactory.getLog(DoclistReadTopDirective.class);
    ...
    public void execute(Environment env, Map params,
        ...
        List<Bean> list = new WenkuServ().getWenjiList(param).getDataList();
