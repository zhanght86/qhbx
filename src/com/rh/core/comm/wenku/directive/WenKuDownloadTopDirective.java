 ...
 * @author liwei 下载排行
 */
public class WenKuDownloadTopDirective implements TemplateDirectiveModel {
    /** log */
    private static Log log = LogFactory.getLog(WenKuDownloadTopDirective.class);
    ...
    public void execute(Environment env, Map params,
        ...
        List<Bean> list = new WenkuServ().getDownloadTopDocument(param).getDataList();
