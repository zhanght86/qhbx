 ...
 * @author liwei 文库积分排行
 */
public class WenkuIntegralTopDirective implements TemplateDirectiveModel {
    /** log */
    private static Log log = LogFactory.getLog(WenkuIntegralTopDirective.class);
    ...
    public void execute(Environment env, Map params,
        ...
        List<Bean> list = new IntegralServ().wenkuTopStatistics(param).getDataList();
