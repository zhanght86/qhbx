 ...
 * 公告
 */
public class ZhidaoNoticeDirective implements TemplateDirectiveModel {
    /** log */
    private static Log log = LogFactory.getLog(ZhidaoNoticeDirective.class);
    ...
    public void execute(Environment env, Map params,
        ...
        param.setId(id);
        OutBean outBean = new ZhidaoServ().getZhidaoNotice(param);
