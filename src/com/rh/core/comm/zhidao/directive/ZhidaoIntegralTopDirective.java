 ...
 * @author liwei 积分排行
 */
public class ZhidaoIntegralTopDirective implements TemplateDirectiveModel {
    /** log */
    private static Log log = LogFactory.getLog(ZhidaoIntegralTopDirective.class);
    ...
    public void execute(Environment env, Map params,
        ...
        List<Bean> list = new ZhidaoServ().topStatistics(param).getDataList();
