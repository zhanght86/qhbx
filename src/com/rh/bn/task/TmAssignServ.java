...
import com.rh.core.comm.todo.TodoRemindTypeMgr;
...
public class TmAssignServ extends CommonServ {
    ...
    public static final String BN_TM_TASK_SERV = "BN_TM_TASK";
    public static final String BN_TM_ASSIGN_SERV = "BN_TM_ASSIGN";
    public static final String TASK_STATE_ASSIGNED ="1";
    public static final String TASK_STATE_CARRYING ="2";
    public static final String TASK_STATE_COMPLETE ="5";
    public static final String TASK_STATE_REMIND ="4";
    public static final String TODO_FLAG_JUDGE ="2";
    public static final String TODO_FLAG_NOT_JUDGE ="1";
    public static final String BN_TM_ASSIGN_REHANDLE_SERV = "BN_TM_ASSIGN_REHANDLE";
    ...
    public Bean beginFeedBack(ParamBean paramBean){
      ...
      //修改标识字段TODO_FLAG的值
        assignStateBean.set("TODO_FLAG", TODO_FLAG_NOT_JUDGE);
...
//        String TASK_ID=paramBean.getStr("TASK_ID");
    ...
    public Bean sendToDoBean(ParamBean paramBean){
      ...
      //修改标识字段TODO_FLAG的值
        sqlBean.set("TODO_FLAG", TODO_FLAG_JUDGE);
    ...
    public Bean rehandleTask(ParamBean paramBean){
        //重新处理任务弹出框点击确定向任务重新办理需求说明表插入数据
        SqlBean sqlBean = new SqlBean();
        sqlBean.and("REHANDLE_ID", paramBean.getStr("REHANDLE_ID"));
        Bean assignBean = ServDao.find(BN_TM_ASSIGN_REHANDLE_SERV, sqlBean);
        if(assignBean==null){
            Bean linkData=new Bean();
            linkData.setId(paramBean.getStr("REHANDLE_ID"));
            linkData.set("ID",paramBean.getStr("IDSTR"));
            linkData.set("REHANDLE_REQUIREMENT", paramBean.getStr("REHANDLE_REQUIREMENT"));
            ServDao.create(BN_TM_ASSIGN_REHANDLE_SERV, linkData);
        }
        return new Bean().set(Constant.RTN_MSG, Constant.RTN_MSG_OK);
    }
