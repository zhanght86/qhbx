...
import com.rh.core.serv.send.SendSchemeMgr;
 ...
 * 
 */
public class GwMainToDict2 implements DictItems {
    /**
     * 用户选择字典
     */
    private String userSelectDict = "SY_ORG_DEPT_SUB";
    ...
    private void appendDeptUser(List<Bean> child) {
        ...
        if (userSelectDict.equals("SY_ORG_DEPT_SUB")) {
