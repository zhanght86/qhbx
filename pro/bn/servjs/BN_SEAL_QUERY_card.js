var _viewer = this;
//删除保存按钮
_viewer.getItem("SEAL_TYPE1").change(function(){
	jQuery("#BN_SEAL_QUERY-SEAL_TYPE2").val("");
	jQuery("#BN_SEAL_QUERY-SEAL_TYPE2__NAME").val("");
});
...
if (queryBtn) {
	queryBtn.unbind("click").click(function(){
		...
		var url = "BN_SEAL_BASIC_INFO.list.do";
		var opts = {
			"url" : url,
			"tTitle" : "印章查询结果", 
