<div style="float:left;width:auto;"><style type="text/css">
.list_ywkb_left{width:209px;}
.h3_ywkb_left{width:209px;height:30px;background: url(/image/image_gallery?uuid=8fbc90d0-c3c6-4aad-82fe-a4a7d394f24e&groupId=10136) no-repeat scroll 0 0 transparent;}
.contentDiv_ywkb_left{width:207px;height:286px;margin-bottom:7px;padding-bottom:10px;
...
.content_info_ywkb_left{width:40px;height:15px;margin:3px 8px 3px 3px;}</style>
...
<div style="float:right;width:auto;"><style type="text/css">
.list_ywkb{width:209px;}
.h3_ywkb{width:209px;height:30px;}
.contentDiv_ywkb{width:207px;margin-bottom:7px;padding-bottom:10px;
background:url(/image/image_gallery?uuid=3b67c5b0-455b-4b5a-bf31-acf29b9b820a&groupId=10136) no-repeat bottom;}
.content_title_ywkb{color:#3399ff;text-align:center;}</style>
<div class="list_ywkb">
