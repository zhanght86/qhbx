...
<%} else {%><!--开发模式-->
	...
	<script type="text/javascript" src="<%=urlPath %>/sy/base/frame/coms/rh.ui.UniteTree.js"></script>
	<!-- 平台UI核心view部分js库 -->
...
<%}%>
<!-- 首创门户需要用到的滚动条文件 -->
<link rel="stylesheet" type="text/css" href="<%=urlPath %>/sc/css/jquery.mCustomScrollbar.css"/>
<script type="text/javascript" src="<%=urlPath %>/sc/js/jquery.mousewheel.min.js" charset="UTF-8"></script>
<script type="text/javascript" src="<%=urlPath %>/sc/js/jquery.mCustomScrollbar.min.js" charset="UTF-8"></script>
