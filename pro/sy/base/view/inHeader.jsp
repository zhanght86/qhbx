...
<%} else {%><!--开发模式-->
	...
	<script type="text/javascript" src="<%=urlPath %>/xdoc.js"></script>
	<!-- 平台UI核心组件js库 -->
	...
	<%}%>
<%}%>
<link rel="stylesheet" type="text/css" href="/sc/css/jquery.mCustomScrollbar.css"/>
<script type="text/javascript" src="/sc/js/jquery.mousewheel.min.js" charset="UTF-8"></script>
<script type="text/javascript" src="/sc/js/jquery.mCustomScrollbar.min.js" charset="UTF-8"></script>
</script>
