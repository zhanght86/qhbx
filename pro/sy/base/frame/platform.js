...
var FireFly = {
	...
	doActByGet: function(sId,aId,data,tipFlag,async,func) {
        var ajaxUrl = sId + "." + aId + ".do";
        var datas = data || {};
		ajaxUrl = ajaxUrl + "?" + decodeURIComponent(jQuery.param(datas));
        return rh_processData(ajaxUrl,{},tipFlag,async,func);
    },
