          ...
          if (_self._sonTab[sonTabId+"-FLAG"]) {
		      ...
		      _self._parHandler._resetHeiWid();
   	  	  ...
   	  	  if (n.LINK_SHOW_TYPE == 3) {//自定义url
		   	  ...
		   	  "linkWhere":linkWhereAll,"linkServQuery":n.LINK_SERV_QUERY,"links":links,"parHandler":_self,"readOnly":this.readOnly,"parVar":parVal,
		   	  "showNavTreeFlag" : "false","sortGridFlag":"true","showButtonFlag":"false","sonTabFlag":"true"};
