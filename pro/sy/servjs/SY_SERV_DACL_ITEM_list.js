...
var ORU_TYPE = {"USER":3,"DEPT":2,"ROLE":1};
...
_viewer.grid.getBodyTr().each(function(i,item){
	...
	var ownerType = itemObj.find("[icode=ORU_TYPE]").text();
	
	if(ownerType == ORU_TYPE.ROLE ){
