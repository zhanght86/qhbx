...
addrelate.unbind("click").bind("click",function(){
	...
	var options = {
			"cardObj":cardObj,
			"config":"[{'servId':'OA_SY_COMM_ENTITY_QUERY','SOURCE':'ENTITY_ID,ENTITY_CODE,TITLE,SERV_ID,S_ATIME,DATA_ID','servName':'综合查询','SHOWITEM':'TITLE','TARGET_SERV_ID_ITEM':'SERV_ID','TARGET_ID_ITEM':'DATA_ID','HIDE':'ENTITY_ID,DATA_ID,SERV_ID'}]",
			"id":servID+"-GW_RELATE",
			"itemCode":"GW_RELATE",
