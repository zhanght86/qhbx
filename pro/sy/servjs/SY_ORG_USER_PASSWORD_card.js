...
var obj = jQuery("<div id='SY_ORG_USER_PASSWORD-USER_PASS_div' class='inner' style='width:97.5%'>" +
		...
		"<input id='SY_ORG_USER_PASSWORD-USER_PASS' type='password' name='SY_ORG_USER_PASSWORD-USER_PASS' class='ui-text-default ui-text-disabled'  style='max-width: 100%; '>" +
		"</span></div>");
...
var obj2 = jQuery("<div id='SY_ORG_USER_PASSWORD-USER_PASS_CHE_div' class='inner' style='width:97.5%'>" +
		...
		"<span class='star'>&nbsp;&nbsp;&nbsp;&nbsp;</span></label></span><span class='right' style='width:65%;'>" +
		"<input id='SY_ORG_USER_PASSWORD-USER_PASS_CHE' type='password' name='SY_ORG_USER_PASSWORD-USER_PASS_CHE' class='ui-text-default ui-text-disabled'  style='max-width: 100%; '>" +
		"</span></div>");
