			...
			<div class="bd-wrap">
				...
				<div class="body">		
					<div class="main" style="width:900px;">
					 ...
					 <@wenku_readTop debugName="热门文档"  page="${page}" count="36"> 
									...
									<table class="list hidden" id="docList" cellpadding="0" cellspacing="0" width="100%">
										...
										<#list tag_list as doc>
												...
												<tr class="hasb">
													...
													<td class="i">
														<span title="${doc.DOCUMENT_FILE_SUFFIX}" class="ic ic-list-${doc.DOCUMENT_FILE_SUFFIX}" ></span>
													</td>
													<td><a
														href="#" class="list_a"
