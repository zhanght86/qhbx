     ...
     **/
    function openMyAsk() {
        var opts={'url':'SY_COMM_ZHIDAO_MYASK.list.do','tTitle':'我的提问','menuFlag':3, 'menuId':'SY_COMM_ZHIDAO_MYASK__ruaho'};
        parent.Tab.open(opts); 
    }
     ...
     **/
    function openAnswer() {
        var opts={'url':'SY_COMM_ZHIDAO_MYANSWER.list.do','tTitle':'我的回答','menuFlag':3, 'menuId':'SY_COMM_ZHIDAO_MYANSWER__ruaho'};
        parent.Tab.open(opts); 
    }
...
//            parent.Tab.open(opts);
    	...
    	var opts={'url':url,'tTitle':'我的个人中心','menuFlag':3,'menuId':'MY_ZHIDAO_CENTER__ruaho',"scrollFlag":true};
        parent.Tab.open(opts); 
    }
    /**
     * 知道分类
