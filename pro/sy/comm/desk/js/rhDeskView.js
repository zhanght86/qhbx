...
rh.vi.deskView.prototype._bldBoxHtml = function() {
	...
	var temp = System.getVar("@C_CAS_MOBILE_LOGIN_ADDR@") || "";
	if ("" == temp) {
		temp = encodeURIComponent(FireFly.getHttpHost() + FireFly.contextPath + "/index_mb.jsp?userCode=" + System.getUser("USER_CODE"));
	}
