...
<#include "/SY_COMM_WENKU/baiduwenku_navigation.ftl">
			...
			<div class="bd-wrap">
				...
				<div class="body">		
					<div class="main">
					 ...
					 <@wenku_doclist_readTop debugName="热门文辑"  page="${page}" count="40"> 
						<div class="mod dataList">
							<ul class="docAlbumTab">
								<li class="selected"><a href="#" class="Doclist">热门文辑</a></li>
									...
									<table class="list" id="docList" cellpadding="0" cellspacing="0" width="100%">
										...
										<#list tag_list as doc>
												...
												<tr class="hasb">
													...
													<td><span>${doc.LIST_READ_COUNTER}次</span></td>
													<td><span>
													${doc.S_MTIME[0..10]}
													</span></td>
												</tr>
	...
	<!-----------begin aside----------------->				
			<div style="height:26px;width:auto;background-color:#FFFFFF;"></div>
