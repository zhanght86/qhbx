	          ...
	          <div style="width:100%;height:30px;">
	           <div style="float:left;display:inline;width:18%;">
	        	<table style='border-collapse:separate;border-spacing:5px;'>
					<tr>
						<td>
							<img id='currentUsImg' width="50" height="50" src="/sy/theme/default/images/common/user1.png" class="rh-user-info-circular-bead">
						</td>
						<td>
	    ...
	    <div class="uc-mod course-info">
	        <div class="hd">
		        ...
		        <div class="tabControl uc-tabs-control">
	                ...
	                |
	                <a class="disabled" href="#js-doclist">文辑贡献</a>
	            </div>
	        </div>
