    ...
    function createDoclist(){
    	//myDoclist();
    	var url="/cms/SY_COMM_CMS_TMPL/0WXXRGwDx6MVKrJzwPklfyz.html";
	 ...
	 **/
    function myDownload(){
    	var opts={'url':'SY_COMM_WENKU_MYDOWNLOAD.list.do','tTitle':'我的下载','menuFlag':2, 'menuId':'SY_COMM_WENKU_MYDOWNLOAD'};
        parent.Tab.open(opts);
      }
     ...
     */
    function myReadHis() {
    	var opts={'url':'SY_COMM_WENKU_MYREAD.list.do','tTitle':'我的浏览','menuFlag':2, 'menuId':'SY_COMM_WENKU_MYREAD'};
        parent.Tab.open(opts);
    }
    ...
    function myWenkuCenter() {
    	var opts={'url':'/cms/SY_COMM_CMS_TMPL/0gHHFcMdFc2apGd1lI6UIoR.html','tTitle':'我的个人中心','menuFlag':2,'menuId':'MY_WENKU_CENTER__ruaho',"scrollFlag":true};
        parent.Tab.open(opts); 
    }
     ...
     **/
     function myDocuments() {
        var opts={'url':'SY_COMM_WENKU_MYDOCUMENT.list.do','tTitle':'我的文档','menuFlag':2,'menuId':'SY_COMM_WENKU_DOCUMENT__ruaho'};
        parent.Tab.open(opts); 
    ...
    function myWenkuIntegral() {
    	var opts={'url':'SY_COMM_WENKU_MY_INTEGRAL.list.do','tTitle':'我的积分','menuFlag':2, 'menuId':'SY_COMM_WENKU_MY_INTEGRAL__ruaho'};
        parent.Tab.open(opts);
     ...
     **/
    function myDoclist() {
    	var opts={'url':'SY_COMM_WENKU_MYDOCLIST.list.do','tTitle':'我的文辑','menuFlag':2, 'menuId':'SY_COMM_WENKU_MYDOCLIST'};
        parent.Tab.open(opts);
