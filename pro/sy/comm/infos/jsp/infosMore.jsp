...
<%
	...
	String chnlid = outBean.getStr("CHNL_ID").trim();
	String chnl_name = outBean.getStr("CHNL_NAME").trim();
...
<td class="elipd" style="width:75%;"><img src="/sy/comm/infos/img/d.png"/><a href="javascript:void(0);" onclick="newsView('<%=bean.getStr("NEWS_ID") %>')" style="margin-left:3px;">
<span style="font-size:12px;"><%=bean.getStr("NEWS_SUBJECT")%></span>
</a></td>
<td class="elipd" style="width:25%;"><span style="float:right;margin-right:30px;color:#999999;font-size:12px;"><%=bean.getStr("NEWS_TIME").substring(0, 10) %></span></td>
</tr>
<%}%>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
if(countPage>1&&currentPage!=1)
	document.write("<a href='SY_COMM_INFOS.getMoreInfos.do?CHNL_ID=<%=chnlid%>&curtentpage="+prevPage+"' onMouseOver=\"pageup.src='/sy/comm/infos/img/page_up_currected.jpg'\"  onMouseOut=\"pageup.src='/sy/comm/infos/img/page_up.jpg'\"><img src=/sy/comm/infos/img/page_up.jpg border=0 name=pageup>&nbsp;<span class=font_c_black>上一页</span></a>&nbsp;");
else
