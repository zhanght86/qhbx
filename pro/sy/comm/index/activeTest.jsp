...
<div>
	<div id="rh_test_container_add" class="rh_test_container">
	    <div class="rh_test_title">1. 可信任站点添加
		<a>请不要启用本站点的浏览器兼容性视图，已加上的请手动删掉。</a></div>
	...
	<div id="rh_test_container_ntko" class="rh_test_container">
	    ...
	    <div id="rh_test_zotnClient" style="width:100%;text-align:center;">
	       <div>如果系统没有自动下载安装文件，可以点此链接手动下载安装<a href='/sy/comm/index/file/ruahoClient-huaxia.exe'>系统插件</a>(打包NTKO和ZotnClient的安装文件)</div>
	    </div>
	</div>
