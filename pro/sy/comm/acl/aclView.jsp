...
<style type="text/css">
	...
	#acl_left{float:left;overflow:scroll;background-color:white;margin-left:10px;height:553px;border:1px solid #ccc;}
	#acl_right {float:left;overflow:scroll;background-color:white;margin-left:10px;height:553px;border:1px solid #ccc;}
</style>
