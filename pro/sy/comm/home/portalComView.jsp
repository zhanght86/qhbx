...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=CONTEXT_PATH %>/sc/css/jquery.mCustomScrollbar.css"/>
    <script type="text/javascript" src="<%=CONTEXT_PATH %>/sc/js/jquery.mousewheel.min.js" charset="UTF-8"></script>
    <script type="text/javascript" src="<%=CONTEXT_PATH %>/sc/js/jquery.mCustomScrollbar.min.js" charset="UTF-8"></script>    
    <script type="text/javascript" src="<%=request.getContextPath() %>/sc/js/jquery.carouFredSel-6.2.1-packed.js" charset="UTF-8"></script>
</head>
