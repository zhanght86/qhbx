...
<div class='portal-box ${boxTheme!""}' style='min-height:200px;background:white;'>
	<div class='portal-box-title portal-title-none'>
		<span class="portal-box-title-icon ${icon}"></span>
		<span class="portal-box-title-label">${title}</span>
	</div>
	<div class='portal-box-con' style='height:${height};padding-bottom:11px;'>
	<table width="98%" cellspacing="0" cellpadding="0" class="noline">
    <tr class="tr3">
        <td bgcolor="#FFFFFF">
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                    <td align="center" style='border-bottom:1px #aaa dotted;padding:4px 0px;'>
                        <#list new as topic>
                        	<#if topic_index == 0>
                        ...
                        <table class="line" align="center" width="100%" cellspacing="0" cellpadding="0" border="0">
							...
							<tr>
                                <td style="line-height:24px;font-size:14px;" align="left">
                                    <a title="${topic.TOPIC_TITLE}" style="color:black;" href="javascript:topicView('${topic.TOPIC_ID}','${topic.TOPIC_TITLE}');">
										${topic.TOPIC_TITLE}
									</a>
                                </td>
