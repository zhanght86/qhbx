...
function openMoreTodoListPage(todoCatlog) {
	...
	var opts = {"url":"SY_COMM_TODO_READ.list.do", "tTitle":tTitle, "menuFlag":4, "params":params};
	Tab.open(opts);
}
</script>

<div id='SY_COMM_TODO_READ' class='portal-box'>
<div class='portal-box-title'><span class='portal-box-title-icon icon_portal_todo'></span><span class="portal-box-title-label">待阅事务</span><span class="portal-box-hideBtn  conHeanderTitle-expand"></span><span class="portal-box-more"><a href="#" onclick="openMoreTodoListPage('2')"></a></span></div>
