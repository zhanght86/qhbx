...
<div id='SY_COMM_INFOS_REPORT' class='portal-box tabs-portal ${boxTheme}' style='height:${height};min-height:200px'>
...
<iframe  src="SY_COMM_INFO.chart.do?_PK_=SY_COMM_INFOS_COUNT" border='solid red ' frameborder='0' width='100%' height='600px' scrolling="auto" ></iframe>
</ul>
...
<script type="text/javascript">
	  ...
	  function quarter(str){ 
	    var src="SY_COMM_INFO.chart.do?_PK_=SY_COMM_INFOS_COUNT";
	    switch (str/3){
	    case 0:
	    {
	     alert(extwhere); 
