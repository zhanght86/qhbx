...
<script type="text/javascript">
	function docView(id,name){
		var url = "/wenku/content/" + id + ".html?group=true";	
...
<div class='portal-box ${boxTheme!""} bor1' style='min-height:240px;'>
	<div class='portal-box-title'>
		...
		<span class="more" onclick="window.location='/sy/comm/page/SY_COMM_TEMPL.show.do?model=view&pkCode=1-QuWdguJ0L8f8tG8YbHMy&$SITE_ID$=${SITE_ID!}';">查看更多&gt;&gt;</span>
	</div>
