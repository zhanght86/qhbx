...
<head>
    ...
    <script type="text/javascript" src="<%=CONTEXT_PATH %>/sc/js/jquery.carouFredSel-6.2.1-packed.js" charset="UTF-8"></script>
    <%
    	//取得个性化引入公共css和js文件
          ...
          if (keyCode == 116) {
          	clearTimeout(timeout);
				var timeout= setTimeout(function(){
					var $tabA = parent.$("#homeTabs").find(".ui-tabs-selected").find("a");
						$iframe = $tabA.data("iframeObj");
						src = $iframe.attr("src");
					$iframe.attr("src",src);
				},100);
              event.keyCode ? event.keyCode = 0 : event.which = 0;
