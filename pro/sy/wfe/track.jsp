...
<table border="0" cellspacing="1" cellpadding="0" width="100%" height="100%">
    ...
    <tr>
    	...
    	<table style="margin: 25px 0px 25px 0px">
       		<tr>
    		<td>
    			<div style="width:140px;height:20px;background-color:#66DA66;margin-left:100px;"></div>
    		</td>
    		<td>
    			<font style='color: #FF0000;font-family: 方正小标宋简体;font-size: 14px;'>&nbsp;绿色表示已流转节点</font>
    		</td>
    		<td>
    			<div style="width:140px;height:20px;background-color:#FF2525;margin-left:100px;"></div>
    		</td>
    		<td>
    			<font style='color: #FF0000;font-family: 方正小标宋简体;font-size: 14px;'>&nbsp;红色表示当前节点</font>
    		</td>
    		<td>
    			<div style="width:140px;height:20px;background-color:#FFC231;margin-left:100px;"></div>
    		</td>
    		<td>
    			<font style='color: #FF0000;font-family: 方正小标宋简体;font-size: 14px;'>&nbsp;黄色表示未流转节点</font>
    		</td>
    	</tr>
    	</table>
