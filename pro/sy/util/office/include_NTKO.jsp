...
<% } else { %>
<object width="1" height="1" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404" codebase="<%=request.getContextPath()%>/sy/util/office/OfficeControl.cab#version=5,0,2,7" id="TANGER_OCX"><PARAM NAME=BorderStyle VALUE=1>
	<PARAM NAME=BorderColor VALUE=14402205>
	<PARAM NAME=TitlebarColor VALUE=14402205>
	<PARAM NAME=TitlebarTextColor VALUE=0>
	<PARAM NAME=Caption VALUE="Office">
