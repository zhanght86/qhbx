...
<table cellspacing="0" cellpadding="0" align="left" width="152px" height="570px" style=" border:1px solid black;border-collapse:collapse;">
    <tbody>
        <tr>
...
<table align="left"  width="10px" height="570px" ></table>
<#if  DATA_index % 4==3>
