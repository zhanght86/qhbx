...
_viewer.fetchData = function() {
	...
	var tr5td1 = jQuery("<td style='width:200px;text-align:center;height:40px;font-size:14px;padding-left: 50px;'>合同编号</td>").appendTo(tr5);
	var tr5td2 = jQuery("<td><input ID='CT_CODE' type='text' size='32'></td>").appendTo(tr5);
	...
	var selectStr = "<div style='width:220px;height:22px;border:solid 1px #aaaaaa;'><select id ='CT_YEAR' name ='CT_YEAR' style='width:218px;height:20px;margin:1px;'>";
	...
	jQuery("#fetchDataQueryDiv").dialog({
		...
		close : function() {
			...
			var params = {};
			params["CT_YEAR"] = jQuery("#CT_YEAR").val();
			params["CT_CODE"] = jQuery("#CT_CODE").val();
