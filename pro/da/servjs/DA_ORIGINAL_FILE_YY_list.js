...
_viewer.fetchData = function() {
	...
	var tr5td1 = jQuery("<td style='width:200px;text-align:center;height:40px;font-size:14px;padding-left: 50px;'>用印审批单编号</td>").appendTo(tr5);
	var tr5td2 = jQuery("<td><input ID='YY_CODE' type='text' size='32'></td>").appendTo(tr5);
	...
	var selectStr = "<div style='width:220px;height:22px;border:solid 1px #aaaaaa;'><select id ='YY_YEAR' name ='YY_YEAR' style='width:218px;height:20px;margin:1px;'>";
	...
	jQuery("#fetchDataQueryDiv").dialog({
		...
		close : function() {
			...
			var params = {};
			params["YY_YEAR"] = jQuery("#YY_YEAR").val();
			params["YY_CODE"] = jQuery("#YY_CODE").val();
