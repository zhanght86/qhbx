...
<%
	...
	Bean bkgBean = bkgServ.getLoginBkgPic();
%>	
...
/** 页面初始化方法：开始 */
$(function(){
    //var imgLink = FireFly.getHttpHost() + FireFly.contextPath + "/file?act=qrCode&value=http://moau.capitalwater.cn&size=200";
    ...
    <div class="login-header">
        <div class="login-header-left">
        	<a href="http://www.capitalwater.cn" target="_blank" title="北京首创股份有限公司" tabindex="-1">
            	<img src="/login/img/login-logo.png" alt="北京首创股份有限公司" />
            </a>
        </div>
        	...
        	<div class="login-section">
                    ...
                    <div class="tab selected">
                        <ul>
                            <li class="item current" id="tab-ukey" data-target="ukey-form">
                                 <div class="login-tab-ukey" style="width: 120px;">
                                     UKey登录
                                 </div>
                            </li>
                            <li>
                            ...
                            <li class="item " id="tab-cert" data-target="cert-form">
                                 <div class="login-tab-cert" style="width: 120px;">
                                                                       证书登录
                                 </div>
                            </li>
                            <li>
                            ...
                            <li class="item "  id="tab-mobile" data-target="mobile-qr-form">
                                 <div class="login-tab-cert" style="width: 119px;">
                                                                       手机版下载
                                 </div>
                            </li>
                        </ul>
                ...
                <div class="login-form-wrapper">
                 	<form id="ukey-form" class="ukey-form active" action="http://caadmin.capitalwater.cn/ekeyLogin.do" method="post">
		                ...
		                <input type="hidden" name="appId" value="281"/>
                   ...
                   <form id="cert-m-form" class="cert-m-form" action="" method="post" style="display:none;">
                    ...
                    <form id="mobile-qr-form" style="display:none;">
                    	<div style="margin-left: 107px;margin-top: 50px;">
							<img id="mb-link-img" src='qrcode.gif' width='150px' height='150px'></img>
							<div class="mb-link-title" style="margin-left:15px;margin-top:10px;font-weight: bold;font-size:18px;">扫描下载客户端</div>
						</div>
                        <div class="form-bottom">
                        	<div style="margin-left:20px;font-size:14px;">
                        		<div>如无法扫描，请在 <span style="font-weight:bold;">手机浏览器</span> 中输入</div>
                        		<!-- <div><span style="color:red;">http://moaupdate.capitalwater.cn</span> 进入下载</div> -->
                        		<div><span style="color:red;">http://moau.capitalwater.cn</span> 进入下载</div>
                        	</div>
