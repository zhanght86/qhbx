<div id='OA_MT_CONFEREE' class='portal-box'>
	<div class='portal-box-title'>
		<span class='portal-box-title-icon icon_portal_todo'></span>
		<span class="portal-box-title-label">会议通知</span>
	...
	<div class='portal-box-con'>
		<table width="100%">
			<#if (_DATA_?size == 0)>
				<tr><td align=center id='haha'>没有相关会议记录！</td></tr>
			</#if>
			<#list _DATA_ as content>
				<tr>
					...
					<td>
						<a href="javascript:void(0);" onclick="openMeetingCard('${content.MEETING_ID}')" title="${content.MEETING_TITLE_V}">
