...
//						picList.push(FireFly.getContextPath() + '/oa/mobile/file-temp-dir/' + fileId + '/' + i + '.jpg?t=' + Math.random());
						picList.push(FireFly.getContextPath() + "/oa/mobile/jsp/download.jsp?fileId=" + fileId + "&pageName=" + i + ".jpg&t=" + Math.random());
					}
					wx.previewImage({
						current: picList[0],
						urls: picList
		...
		if (item["FILE_CAT"] == this.itemCode) {
			...
			$(
					"<li class='zhbx-file-link' style='color:#5C5CE8;' data-href='" + FireFlyContextPath + "/file/"
							...
							+ "<img src='/oa/mobile/css/customImages/file-icon/file-icon-" + fileMtypeH + ".png' class='ui-li-icon' />" 
