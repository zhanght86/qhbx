...
<div  class='portal-box pt-gsyw-wrapper' id='BN_JGDT__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_JGDT__temp #BN_JGDT__box").html();
		jQuery("#BN_JGDT__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_JGDT__box'>" + boxHtml + "</div>");
	});
</script>