...
<div  class='portal-box pt-gsyw-wrapper' id='BN_DEPT_DEVEL__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_DEPT_DEVEL__temp #BN_DEPT_DEVEL__box").html();
		jQuery("#BN_DEPT_DEVEL__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_DEPT_DEVEL__box'>" + boxHtml + "</div>");
	});
</script>