...
<div  class='portal-box pt-gsyw-wrapper' id='BN_LINE_FAX__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_LINE_FAX__temp #BN_LINE_FAX__box").html();
		jQuery("#BN_LINE_FAX__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_LINE_FAX__box'>" + boxHtml + "</div>");
	});
</script>