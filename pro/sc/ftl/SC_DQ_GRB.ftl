<div class='portal-box portal-box-dq dq-header-tzz' style='height:497px'>
	...
	<div class='portal-box-con-dq dq-content dq-tzz-h clearfix'>
		<#if _DATA_?size !=0 >
			<div>
	            <div class="dq-summary js-${_DATA_[0].CHNL_ID}">
			...
			<script type ="text/javascript" >
				...
				var param = {};
					param['size']	  = 50;
					param['newsBody'] = '${_DATA_[0].NEWS_BODY}';
				var result = FireFly.doAct("SC_COREMAIL_SERV","replaceHtmlTag",param);
				jQuery("#${_DATA_[0].CHNL_ID}").prepend(result.newsBody);
