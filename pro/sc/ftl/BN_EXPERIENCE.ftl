...
<div  class='portal-box pt-gsyw-wrapper' id='BN_EXPERIENCE__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_EXPERIENCE__temp #BN_EXPERIENCE__box").html();
		jQuery("#BN_EXPERIENCE__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_EXPERIENCE__box'>" + boxHtml + "</div>");
	});
</script>