	...
	<div class='dq-tab-wrapper'>
		<ul class='tabControl' id='tabControl'>
            <li class='dq-tab-item current'>
                <a href='#js-jjjc'> 纪检监察 </a>
            </li>
            <li class='dq-tab-item'>
                <a href='#js-gzzd'> 规章制度 </a>
            </li>
        </ul>
	</div>	    
	<div id="js-jjjc" class='portal-box-con-dq dq-content dq-tab-h clearfix'>
		<#if _DATA_0._DATA_?size !=0 >
			...
			<a href="javascript:void(0);" onclick="openDqListMoreByChnl('${_DATA_0._DATA_[0].CHNL_ID}','计划总结')" class="dq-more-bottom dq-red">更多&gt;&gt;</a> 
		<#else>
			 暂无内容! 
		</#if>	
	</div>
	<div id="js-gzzd" class='portal-box-con-dq dq-content dq-tab-h clearfix' style="display:none;">
		<#if _DATA_1._DATA_?size !=0 >
			...
			<a href="javascript:void(0);" onclick="openDqListMoreByChnl('${_DATA_1._DATA_[0].CHNL_ID}','规则制度')" class="dq-more-bottom dq-red">更多&gt;&gt;</a> 
		<#else>
			 暂无内容! 
		</#if>
	</div>
