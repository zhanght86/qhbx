...
<div class='pt-gsyw-wrapper portal-box-title' style='position:relative;'>
	...
	<span class="portal-box-title-label">通知公告</span>
...
<script>
	...
	function createNews(newsLists){
		for(var i=0;i<newsLists._DATA_.length;i++){
			...
			var newsList = "<tr><td class='icon'></td><td style='width:69%;position: relative;padding-left:3px;'><a id = '${CHNL_ID}"+listBean.NEWS_ID+"' title='"+listBean.NEWS_SUBJECT+"' style='width:100%;margin-left:3px;display: block;height:28px;' news-id='"+listBean.NEWS_ID+"' href='javascript:void(0);' onclick='newsView(this)'><span class='elipd' >"+listBean.NEWS_SUBJECT+"</span>	</a></td><td style='width:26%;'><span style='float:right;margin-right:6px;color:#999999;'>["+listBean.NEWS_TIME.substring(0,10)+"]</span></td></tr>";
