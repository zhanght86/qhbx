<div id="tinyPanel-wrapper" class="tiny-vertical" style="height:${hei};width:auto;margin:4px auto;position:relative;">
    ...
    <a id="webPre" style="filter:alpha(opacity=0);color:#1b1b1b;background-color:black;position:absolute;top:0px;left:0px;width:30%;height:${hei}; display: none;" href="javascript:openContacturl('W');">问卷</a>
	<a id="webNext" style="filter:alpha(opacity=0);color:#1b1b1b;background-color:black;position:absolute;top:0px;right:0px;width:70%;height:${hei}; display: none;" href="javascript:openContacturl('P');">评优</a>
