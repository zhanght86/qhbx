...
<div  class='portal-box pt-gsyw-wrapper' id='BN_SHICHANGYANJIU__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_SHICHANGYANJIU__temp #BN_SHICHANGYANJIU__box").html();
		jQuery("#BN_SHICHANGYANJIU__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_SHICHANGYANJIU__box'>" + boxHtml + "</div>");
	});
</script>