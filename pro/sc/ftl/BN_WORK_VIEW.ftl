...
<div  class='portal-box pt-gsyw-wrapper' id='BN_WORK_VIEW__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_WORK_VIEW__temp #BN_WORK_VIEW__box").html();
		jQuery("#BN_WORK_VIEW__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_WORK_VIEW__box'>" + boxHtml + "</div>");
	});
</script>