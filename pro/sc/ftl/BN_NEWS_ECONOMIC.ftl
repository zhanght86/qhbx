...
<div  class='portal-box pt-gsyw-wrapper' id='BN_NEWS_ECONOMIC__box'>
...
<script type ="text/javascript" >
	jQuery(document).ready(function(jQuery) {
		var boxHtml = jQuery("#BN_NEWS_ECONOMIC__temp #BN_NEWS_ECONOMIC__box").html();
		jQuery("#BN_NEWS_ECONOMIC__temp").html("<div class='portal-box pt-gsyw-wrapper' id='BN_NEWS_ECONOMIC__box'>" + boxHtml + "</div>");
	});
</script>