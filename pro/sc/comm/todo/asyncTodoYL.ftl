...
<div class="pt-todo-item clearfix">
	<div class="fl w60">
		...
		<div class="fl title-col">
			<a href="javascript:void(0);" class="elipd" title="${TODO_TITLE}" onclick="openUrlPage('${TODO_URL}','${SYS_CODE}','${TODO_CODE_NAME}','${TODO_ID}','${SERV_ID}','${TODO_OBJECT_ID1}','${TODO_CATALOG}','${OWNER_CODE}','${TODO_CONTENT}')">${SHORT_TITLE}</a>
		</div>
	</div>
	<div class="fr w40">
